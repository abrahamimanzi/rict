          ...
          <div class="col-sm-12">
                ...
                <div class="box box-info">
                          ...
                          <tbody>
                            <?php
                                ...
                                if(!$events_select->count()){
                                  ...
                                  <tr>
                                    <td><a href="<?=DN?>/app/EventApp/<?=$events_ID?>"><?=$events_data->ID;?></a></td>
                                      <td><a href="<?=DN?>/app/EventApp/<?=$events_ID?>"><?=$events_data->name?></a></td>
                    ...
                    <div class="box-footer clearfix">
                      <a href="<?=DN?>/app/EventApp/list" class="btn btn-sm btn-default btn-flat pull-right">View All Events</a>
                    </div>
                    <!-- /.box-footer -->
                  </div>
                 <!--RECENT REGISTER -->
