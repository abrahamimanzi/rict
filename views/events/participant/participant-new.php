<section class="content-header">
	<div class="page_header">
		<div class="row">
            ...
            <a href="<?=DN?>/app/EventApp/home"><i class="fa fa-book fa-lg pink-col"></i></a> <small> <i class="fa fa-angle-double-right"></i> </small>
					<?=$event_data->name;?>
				</h3>
			</div>
                  ...
                  <li>
                    ...
                    <ul class="menu">
                      <li><!-- start notification -->
                        <a href="<?=DN?>/app/EventApp/<?=$event_ID?>/participant-new">
              ...
              <form method="post" class="form-horizontal">
                ...
                <div class="box box-info">
                    ...
                    <div class="box-footer clearfix">
                        <a href="<?=DN?>/app/EventApp/home" class="btn btn-sm btn-default btn-flat pull-left">Cancel</a>
