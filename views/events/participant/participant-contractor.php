                                                        ...
                                                        <div class="col-xs-6">
                                                          <div>
                                                            <?php if($participant_data->photo){?>
                                                                <img src="<?=DN._.$participant_data->photo?>" class="img " style="width: 100px; padding-bottom: 10px">
                                                            <?php }?>
                                                          </div>
                                                        </div>
                                                        </div>
                    ...
                    <div class="box-footer clearfix">
                      <a href="<?=DN?>/app/EventApp/<?=$event_ID?>/participant-list" class="btn btn-sm btn-default btn-flat pull-right">View All Participants</a>
                        <?php  
                            ...
                            <!-- <a href="<?=DN?>/app/EventApp/<?=$event_ID?>/participant-list-exportmsgeek" class="btn btn-sm btn-primary btn-flat pull-right">Export</a> -->
                        <?php } ?>
                    </div>
                    <!-- /.box-footer -->
                  </div>
